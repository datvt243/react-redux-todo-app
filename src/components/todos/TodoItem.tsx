...
function TodoListItem({ item, onMoveToTrash, onMarkAsImportant, onUpdateTodoRecord, onMarkAsDone, onDelete }: iProps) {
    return (
                ...
                <div>
                    <div className="d-flex" style={{ marginTop: '4px' }}>
                                ...
                                <div className="col-auto">
                                    <span
                                        ...
                                        onClick={() => {
                                            ...
                                            onMarkAsImportant(item.id);
                                        }}
                                    >
                                        <FontAwesomeIcon
                                            icon={faStar}
                                            className={item?.group === 'important' ? 'opacity-100 text-warning' : 'opacity-25'}
                                        />
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className="col-auto ps-3">
                            <ReactDropdown text="" disabled={item.isDone || false}>
                                <li>
                                    <a
